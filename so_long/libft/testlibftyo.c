...
printf("FONCTION char *ft_strtrim(const char *str, const char *set)\n");
	char const	*a55 = "ppop  op o ppppppppo Je n aime pas trop la salade opppooopop";
	char const	*b55 = "ppop op o                  pppo";	
...
printf("----------------------------------------------------------------------------\n");	
printf("FONCTION char**ft_split(char const *str, char c)\n");
const char *input_string = "Ceci est un exemple de texte a diviser";
    ...
    free(result); 
printf("----------------------------------------------------------------------------\n");	
printf("FONCTION char   *ft_itoa(int nb)\n");
    int number = 12345; 

    char *resultat;
	resultat = ft_itoa(number);

    printf("La chaine convertie est : %s\n", resultat);
